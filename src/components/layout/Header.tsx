      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className="bg-indigo-600 text-white hover:bg-indigo-700 active:scale-[0.98] px-5 py-2.5 rounded-xl text-sm font-bold transition-all shadow-lg shadow-indigo-600/10"
          >
            View Demo
          </Link>
        </div>
